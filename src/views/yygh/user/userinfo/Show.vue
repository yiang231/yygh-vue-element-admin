<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="证件类型" prop="param.certificatesTypeString" />
      <el-table-column label="证件编号" prop="certificatesNo" />
      <el-table-column label="性别">
        <template slot-scope="scope">
          {{ scope.row.sex === 1 ? '男' : '女' }}
        </template>
      </el-table-column>
      <el-table-column label="出生年月" prop="birthdate" />
      ...
      <el-table-column label="地址" prop="param.fullAddress" />
